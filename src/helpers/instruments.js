const instruments = [
  ...
  {
    id: 2,
    img: 'https://static.dnipro-m.ua/cache/products/5100/catalog_origin_323616.jpg',
    name: 'Перфоратор',
    price: 3897,
    description:
      'Перфоратор бочковий Dnipro-M ВН-10 використовується для виконання широкого спектру будівельних і ремонтних робіт: буріння та свердління отворів, розмішування будівельних сумішей, демонтажу і т.д.',
  },
  {
    id: 3,
    img: 'https://static.dnipro-m.ua/cache/products/9598/catalog_origin_469356.jpg',
    name: 'Шліфмашина',
    price: 1299,
    description:
  ...
  {
    id: 5,
    img: 'https://static.dnipro-m.ua/cache/products/2021/catalog_origin_323421.jpg',
    name: 'Рівень',
    price: 897,
    description:
